...
namespace Mobicommerce\Deliverydate\Block\Adminhtml\Dinterval\Edit\Tab;
...
class General extends Generic implements TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $model = $this->_coreRegistry->registry('current_mobicommerce_deliverydate_dinterval');
        ...
        $fromMonthElement = $fieldset->addField(
            ...
            [
                ...
                'title' => __('From Month'),
                'name' => 'from_month',
                'values' => $this->mobiHelper->getMonths()
            ]
        );
        ...
        $fromYearElement = $fieldset->addField(
            ...
            [
                ...
                'title' => __('From Year'),
                'name' => 'from_year',
                'values' => $this->mobiHelper->getYears()
            ]
        );
