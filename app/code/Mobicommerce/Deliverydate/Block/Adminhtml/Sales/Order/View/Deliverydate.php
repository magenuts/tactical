...
namespace Mobicommerce\Deliverydate\Block\Adminhtml\Sales\Order\View;
...
class Deliverydate extends \Magento\Framework\View\Element\Template
{
    ...
    protected function _construct()
    {
        ...
        $this->setTemplate('Mobicommerce_Deliverydate::delivery_view.phtml');
    ...
    public function getEditUrl() {
        return $this->getUrl('mobicommerce_deliverydate/deliverydate/edit', ['order_id' => $this->_getOrderId()]);
    }
