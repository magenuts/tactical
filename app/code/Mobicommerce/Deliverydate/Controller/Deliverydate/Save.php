...
class Save extends \Magento\Framework\App\Action\Action
{
     ...
     * Can be used by Guest @see \Mobicommerce\Deliverydate\Controller\Guest\Save
     *
     ...
     * @param \Mobicommerce\Deliverydate\Model\Deliverydate $deliverydate
    ...
    protected function sendNotification($wasDate, $deliverydate, $order)
    {
        ...
        $this->transportBuilder
            ->setTemplateIdentifier('mobideliverydate_admin_email_template')
