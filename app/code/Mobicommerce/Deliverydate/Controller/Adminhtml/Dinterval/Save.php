...
class Save extends \Mobicommerce\Deliverydate\Controller\Adminhtml\Dinterval
{
    public function execute()
    {
        if ($this->getRequest()->getPostValue()) {
            ...
            try {
                /** @var \Mobicommerce\Deliverydate\Model\Dinterval $model */
                ...
                if (!empty($id)) {
                    ...
                    $this->_redirect('mobicommerce_deliverydate/*/new');
                }
                return;
            } catch (\Exception $e) {
                ...
                $this->session->setPageData($data);
                $this->_redirect('mobicommerce_deliverydate/*/edit', ['id' => $this->getRequest()->getParam('dinterval_id')]);
                return;
            }
        }
    }
    ...
    /**
     * @param \Mobicommerce\Deliverydate\Model\Dinterval $model
     * @param array                                $data
     *
     * @return bool
