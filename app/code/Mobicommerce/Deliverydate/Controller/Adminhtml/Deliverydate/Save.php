...
class Save extends \Mobicommerce\Deliverydate\Controller\Adminhtml\Deliverydate
{
                ...
                if (is_array($data) && !empty($data)) {
                    ...
                    if (array_key_exists('notify', $data) && $email) {
                        if ($wasDate != $deliveryDate->getDate() || $wasTime != $deliveryDate->getTime()) {
                            ...
                            $templateId = $templateId ? $templateId : 'mobideliverydate_general_email_template';
