...
class Save extends \Mobicommerce\Deliverydate\Controller\Adminhtml\Holidays
{
    public function execute()
    {
        if ($this->getRequest()->getPostValue()) {
            ...
            try {
                ...
                $this->_redirect('mobicommerce_deliverydate/*/edit', ['id' => $this->getRequest()->getParam('holiday_id')]);
                return;
            }
        }
    }
