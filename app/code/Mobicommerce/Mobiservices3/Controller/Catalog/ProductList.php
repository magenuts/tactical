...
class ProductList extends \Mobicommerce\Mobiservices3\Controller\Action\Action {
    ...
    public function execute()
    {
        $this->_eventManager->dispatch(
            'mobicommerce_webservice_controller_catalog_listing_before',
        ...
        $this->_eventManager->dispatch(
            'mobicommerce_webservice_controller_catalog_product_listing_after',
