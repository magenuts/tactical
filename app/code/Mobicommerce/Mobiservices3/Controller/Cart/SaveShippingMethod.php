...
class SaveShippingMethod extends \Mobicommerce\Mobiservices3\Controller\Action\Action {
    ...
    public function execute()
    {
        $this->_eventManager->dispatch(
            'mobicommerce_webservice_controller_checkout_cart_shippingmethod_save_before',
        ...
        $info = $model->saveShippingMethod($data);
        
        $this->_eventManager->dispatch(
            'mobicommerce_webservice_controller_checkout_cart_shippingmethod_save_after',
