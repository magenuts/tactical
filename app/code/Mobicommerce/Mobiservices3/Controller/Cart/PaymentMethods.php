...
class PaymentMethods extends \Mobicommerce\Mobiservices3\Controller\Action\Action {
    ...
    public function execute()
    {
        $this->_eventManager->dispatch(
            'mobicommerce_webservice_controller_checkout_cart_payment_load_before',
        ...
        $info = $model->getPaymentMethos($data);
        
        $this->_eventManager->dispatch(
            'mobicommerce_webservice_controller_checkout_cart_payment_load_after',
