...
class UpdateCart extends \Mobicommerce\Mobiservices3\Controller\Action\Action {
    ...
    public function execute()
    {
        $this->_eventManager->dispatch(
            'mobicommerce_webservice_controller_cart_update_item_before',
        ...
        $this->_eventManager->dispatch(
            'mobicommerce_webservice_controller_cart_update_item_after',
